  ...
  return (
    <div onMouseMove={(e) => { mouseX.set(e.clientX); mouseY.set(e.clientY); }} className="relative min-h-screen bg-[#0a0a0a] text-white font-sans overflow-hidden">
      ...
      <section className="pt-40 pb-20 px-6 text-center">
        ...
        <p className="text-zinc-400 max-w-xl mx-auto text-lg">Gestión de élite para creadores.</p>
      </section>
      ...
      <section className="px-6 py-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-zinc-900/50 border border-white/10 p-8 rounded-[2rem]">
          ...
          <p className="text-zinc-400">Viralidad garantizada con análisis de datos.</p>
        </div>
        <div className="bg-zinc-900/50 border border-white/10 p-8 rounded-[2rem]">
          <h3 className="text-2xl font-bold text-blue-500 mb-2">Edición</h3>
          <p className="text-zinc-400">Contenido diseñado para retener a tu audiencia.</p>
        </div>
      </section>
    </div>
  );
